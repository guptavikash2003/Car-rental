...
const AddCars = () => {
  ...
  return (
    <div className='px-4 ру-10 md:px-10 flex-l'>
   ...
   booking, including pricing, availability, and car specifications."/>
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        {/* Car Details */}
        {/* Car Brand & Model */}
        <div className='grid grid-cols-l md:grid-cols-2 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <input type="text" placeholder="  e.g. X5, E-Class, M4..." required
              className='xx-3 py-2 mt-1 border border-borderColor rounded-md  outline-none'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
          ...
          <div className='flex flex-col w-full'>
            ...
            <select onChange={e => setCar({ ...car, category: e.target.value })}
              value={car.category} className='pk-3 py-2 mt-1 border border-borderColor rounded-md outline-none'>
        ...
        <div className='flex flex-col w-full'>
          ...
          <textarea rows={5} placeholder="e.g. A luxurious SUV with a spacious interior and a powerful engine." required className='px-3 ру-2 mt-1 border border-borderColor rounded-md outline-none'
