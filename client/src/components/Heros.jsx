...
const Heros = () => {
    ...
    const { pickupDate, returnDate, setReturnDate, setPickupDate, navigate } = useAppContext();
    ...
    return (
        <motion.div
            ...
            className="flex flex-col items-center justify-center h-screen gap-15 bg-light text-center bg-gray-100">
            ...
            <motion.form initial={{ scale: 0.95, opacity: 0, y: 50 }}
                ...
                onSubmit={handleSearch} className='flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-1g md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[@px_8px_20px_rgba(0,0,0,0.1)]' >
                ...
                <motion.button whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center justify-center gap-2 px-6 py-3 max-sm:mt-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer shadow transition-all duration-200">
