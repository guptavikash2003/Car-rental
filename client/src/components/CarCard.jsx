...
const CarCard = ({ car }) => {
    ...
    return (
        <div onClick={() => { navigate(`/car-details/${car._id}`); scrollTo(0, 0) }} className="group rounded-xl overflow-hidden shadow-1g hover:-translate-y-1
  transition-all duration-500 cursor-pointer" >
      ...
      text-white рх-3 ру-2 rounded-lg">
